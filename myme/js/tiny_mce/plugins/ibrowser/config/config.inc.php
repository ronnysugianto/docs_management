...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> 'ottimmo/admin/assets/ibrowser/',
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> 'ottimmo/admin/assets/ibrowser/',
	...
	$cfg['ilibs_dir'] 	   = array('ottimmo/admin/assets/ibrowser/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
